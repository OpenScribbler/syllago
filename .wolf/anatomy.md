...
- `develop-precompact.ts` — ~/.config/pai/hooks/develop-precompact.ts (~875 tok)
...
- `CHANGELOG.md` — MOAT Specification Changelog (~7033 tok)
- `moat-spec.md` — Model for Origin Attestation and Trust (MOAT) Specification (~21428 tok)
...
## ../syllago-docs/src/content/docs/moat/

- `registry-add-signing-identity.mdx` — Why Pinning Matters (~2272 tok)
...
- `trust.go` — UserFacingBadge, TrustDescription, TrustDetailExplanation (~2259 tok)
- `types.go` — Struct: RegistrySource (~2459 tok)

## ../syllago-ztejd/cli/internal/moat/

- `enrich.go` — FindContentEntry, EnrichCatalog (~1981 tok)
- `producer.go` — EnrichFromMOATManifests, ScanAndEnrich (~3095 tok)

## ../syllago-ztejd/cli/internal/tui/

- `actions.go` — Struct: removeDoneMsg (~5314 tok)
- `app_update.go` — Declares checkbox (~4736 tok)
- `app.go` — Struct: App (~4244 tok)
- `cards.go` — Struct: cardData (~3324 tok)
- `contents.go` — Struct: contentGroup (~2275 tok)
- `explorer.go` — Struct: itemSelectedMsg (~7550 tok)
- `golden_moat_test.go` — TestGolden_MOAT_Library_60x20, TestGolden_MOAT_Library_80x30, TestGolden_MOAT_Library_120x40, TestGo (~1879 tok)
- `install_view.go` — Struct: conflictOpt (~5496 tok)
- `library.go` — Struct: libraryDrillMsg (~5862 tok)
- `metapanel_test.go` — TestMetaBarLinesFor, TestRenderMetaPanel_HeightContract, TestRenderMetaPanel_TrustLine, TestRenderMe (~2300 tok)
- `metapanel.go` — Struct: metaPanelData (~2498 tok)
- `publisher_warn.go` (~586 tok)
- `styles.go` (~1438 tok)
- `table.go` — Struct: tableModel (~6421 tok)
- `testhelpers_test.go` (~2016 tok)
- `trust_inspector_test.go` — TestTrustInspector_OpenForItem_Activates, TestTrustInspector_OpenForItem_TitleIdentifiesSubject, Tes (~4931 tok)
- `trust_inspector.go` — Struct: RegistryTrustSummary (~3818 tok)

## ../syllago-ztejd/tests/smoke/

- `moat-trust-surfacing.sh` — moat-trust-surfacing.sh — Manual smoke fixture for MOAT TUI trust surfacing (~3400 tok)
...
- `work-stats.md` — Syllago — Work Statistics (~8482 tok)

## .beads.bak.20260414/

- `.gitignore` — Git ignore rules (~252 tok)
- `.local_version` (~2 tok)
- `beads.db-shm` (~8738 tok)
- `beads.db-wal` (~2205 tok)
...
## .beads/embeddeddolt/beads/.dolt/temptf/

- `dolt_embedded_metrics` (~0 tok)

## .capmon-cache/

- `last-run.json` (~145 tok)

## .capmon-cache/amp/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/amp/hooks-1/

- `meta.json` (~51 tok)

## .capmon-cache/amp/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/amp/mcp-1/

- `meta.json` (~51 tok)

## .capmon-cache/amp/mcp-2/

- `meta.json` (~51 tok)

## .capmon-cache/amp/mcp.0/

- `extracted.json` (~2174 tok)
- `meta.json` (~96 tok)

## .capmon-cache/amp/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/amp/rules-1/

- `meta.json` (~51 tok)

## .capmon-cache/amp/rules.0/

- `extracted.json` — : Language, framework, and tool-specific use cases with Thread links", (~825 tok)
- `meta.json` (~89 tok)

## .capmon-cache/amp/rules.1/

- `extracted.json` — Declares is (~2527 tok)
- `meta.json` (~94 tok)

## .capmon-cache/amp/rules.2/

- `extracted.json` (~501 tok)
- `meta.json` (~68 tok)

## .capmon-cache/amp/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/amp/skills.0/

- `extracted.json` (~79 tok)
- `meta.json` (~71 tok)

## .capmon-cache/claude-code/agents-0/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/agents.0/

- `extracted.json` (~9849 tok)
- `meta.json` (~74 tok)

## .capmon-cache/claude-code/commands-0/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/commands.0/

- `extracted.json` — Declares to (~9480 tok)
- `meta.json` (~74 tok)

## .capmon-cache/claude-code/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/hooks-1/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/hooks-2/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/hooks-3/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/hooks-4/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/hooks.0/

- `extracted.json` (~43876 tok)
- `meta.json` (~73 tok)

## .capmon-cache/claude-code/hooks.1/

- `extracted.json` (~8974 tok)
- `meta.json` (~75 tok)

## .capmon-cache/claude-code/hooks.2/

- `extracted.json` (~750 tok)
- `meta.json` (~87 tok)

## .capmon-cache/claude-code/hooks.3/

- `extracted.json` (~562 tok)
- `meta.json` (~89 tok)

## .capmon-cache/claude-code/hooks.4/

- `extracted.json` (~122 tok)
- `meta.json` (~88 tok)

## .capmon-cache/claude-code/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/mcp.0/

- `extracted.json` (~10660 tok)
- `meta.json` (~72 tok)

## .capmon-cache/claude-code/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/rules.0/

- `extracted.json` — Declares the (~5043 tok)
- `meta.json` (~73 tok)

## .capmon-cache/claude-code/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/claude-code/skills.0/

- `extracted.json` — Declares indicators (~7006 tok)
- `meta.json` (~73 tok)

## .capmon-cache/cline/commands-0/

- `meta.json` (~51 tok)

## .capmon-cache/cline/commands.0/

- `extracted.json` (~1051 tok)
- `meta.json` (~77 tok)

## .capmon-cache/cline/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/cline/hooks.0/

- `extracted.json` (~5640 tok)
- `meta.json` (~74 tok)

## .capmon-cache/cline/hooks.1/

- `extracted.json` (~78 tok)
- `meta.json` (~90 tok)

## .capmon-cache/cline/hooks.2/

- `extracted.json` (~58 tok)
- `meta.json` (~88 tok)

## .capmon-cache/cline/hooks.3/

- `extracted.json` (~311 tok)
- `meta.json` (~88 tok)

## .capmon-cache/cline/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/cline/mcp-1/

- `meta.json` (~51 tok)

## .capmon-cache/cline/mcp.0/

- `extracted.json` (~1757 tok)
- `meta.json` (~78 tok)

## .capmon-cache/cline/mcp.1/

- `extracted.json` (~5205 tok)
- `meta.json` (~77 tok)

## .capmon-cache/cline/mcp.2/

- `extracted.json` (~217 tok)
- `meta.json` (~86 tok)

## .capmon-cache/cline/mcp.3/

- `extracted.json` (~209 tok)
- `meta.json` (~92 tok)

## .capmon-cache/cline/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/cline/rules.0/

- `extracted.json` — /*.ts", (~3190 tok)
- `meta.json` (~76 tok)

## .capmon-cache/cline/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/cline/skills-1/

- `meta.json` (~51 tok)

## .capmon-cache/cline/skills.0/

- `extracted.json` (~2721 tok)
- `meta.json` (~75 tok)

## .capmon-cache/cline/skills.1/

- `extracted.json` — Declares of (~3147 tok)
- `meta.json` (~88 tok)

## .capmon-cache/codex/agents-0/

- `meta.json` (~51 tok)

## .capmon-cache/codex/agents-1/

- `meta.json` (~51 tok)

## .capmon-cache/codex/agents-2/

- `meta.json` (~51 tok)

## .capmon-cache/codex/agents-3/

- `meta.json` (~51 tok)

## .capmon-cache/codex/agents.0/

- `extracted.json` (~15136 tok)
- `meta.json` (~90 tok)

## .capmon-cache/codex/agents.1/

- `extracted.json` — Declares is (~156 tok)
- `meta.json` (~88 tok)

## .capmon-cache/codex/agents.2/

- `extracted.json` (~371 tok)
- `meta.json` (~92 tok)

## .capmon-cache/codex/agents.3/

- `extracted.json` (~56 tok)
- `meta.json` (~92 tok)

## .capmon-cache/codex/commands-0/

- `meta.json` (~51 tok)

## .capmon-cache/codex/commands.0/

- `extracted.json` (~64 tok)
- `meta.json` (~87 tok)

## .capmon-cache/codex/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-1/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-10/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-11/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-12/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-13/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-14/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-15/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-2/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-3/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-4/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-5/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-6/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-7/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-8/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks-9/

- `meta.json` (~51 tok)

## .capmon-cache/codex/hooks.0/

- `extracted.json` (~126 tok)
- `meta.json` (~101 tok)

## .capmon-cache/codex/hooks.1/

- `extracted.json` (~923 tok)
- `meta.json` (~102 tok)
...
- `extracted.json` (~713 tok)
- `meta.json` (~87 tok)

## .capmon-cache/codex/hooks.2/

- `extracted.json` (~127 tok)
- `meta.json` (~102 tok)

## .capmon-cache/codex/hooks.3/

- `extracted.json` (~575 tok)
- `meta.json` (~102 tok)
...
- `extracted.json` (~115 tok)
- `meta.json` (~99 tok)

## .capmon-cache/codex/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/codex/mcp-1/
...
- `extracted.json` (~3428 tok)
- `meta.json` (~91 tok)

## .capmon-cache/codex/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/codex/rules-1/

- `meta.json` (~51 tok)

## .capmon-cache/codex/rules.0/

- `extracted.json` (~72 tok)
- `meta.json` (~85 tok)

## .capmon-cache/codex/rules.1/

- `extracted.json` — Declares calls (~8866 tok)
- `meta.json` (~83 tok)

## .capmon-cache/codex/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/codex/skills-1/

- `meta.json` (~51 tok)

## .capmon-cache/codex/skills-2/

- `meta.json` (~51 tok)

## .capmon-cache/codex/skills.0/

- `extracted.json` (~101 tok)
- `meta.json` (~89 tok)

## .capmon-cache/codex/skills.1/

- `extracted.json` (~583 tok)
- `meta.json` (~89 tok)

## .capmon-cache/codex/skills.2/

- `extracted.json` (~62 tok)
- `meta.json` (~84 tok)

## .capmon-cache/copilot-cli/agents-0/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/agents-1/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/agents.0/

- `extracted.json` (~5850 tok)
- `meta.json` (~96 tok)

## .capmon-cache/copilot-cli/agents.1/

- `extracted.json` (~2361 tok)
- `meta.json` (~104 tok)

## .capmon-cache/copilot-cli/commands-0/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/commands-1/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/commands-2/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/commands.0/

- `extracted.json` (~2165 tok)
- `meta.json` (~98 tok)

## .capmon-cache/copilot-cli/commands.1/

- `extracted.json` (~10920 tok)
- `meta.json` (~100 tok)

## .capmon-cache/copilot-cli/commands.2/

- `extracted.json` (~1654 tok)
- `meta.json` (~101 tok)

## .capmon-cache/copilot-cli/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/hooks-1/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/hooks-2/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/hooks.0/

- `extracted.json` (~2108 tok)
- `meta.json` (~94 tok)

## .capmon-cache/copilot-cli/hooks.1/

- `extracted.json` (~536 tok)
- `meta.json` (~99 tok)

## .capmon-cache/copilot-cli/hooks.2/

- `extracted.json` (~6400 tok)
- `meta.json` (~98 tok)

## .capmon-cache/copilot-cli/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/mcp-1/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/mcp.0/

- `extracted.json` — Declares by (~2539 tok)
- `meta.json` (~101 tok)

## .capmon-cache/copilot-cli/mcp.1/

- `extracted.json` (~2854 tok)
- `meta.json` (~91 tok)

## .capmon-cache/copilot-cli/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/rules-1/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/rules-2/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/rules.0/

- `extracted.json` (~824 tok)
- `meta.json` (~103 tok)

## .capmon-cache/copilot-cli/rules.1/

- `extracted.json` (~378 tok)
- `meta.json` (~96 tok)

## .capmon-cache/copilot-cli/rules.2/

- `extracted.json` (~6345 tok)
- `meta.json` (~96 tok)

## .capmon-cache/copilot-cli/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/skills-1/

- `meta.json` (~51 tok)

## .capmon-cache/copilot-cli/skills.0/

- `extracted.json` (~489 tok)
- `meta.json` (~95 tok)

## .capmon-cache/copilot-cli/skills.1/

- `extracted.json` (~780 tok)
- `meta.json` (~100 tok)

## .capmon-cache/crush/mcp.0/

- `extracted.json` (~5423 tok)
- `meta.json` (~86 tok)

## .capmon-cache/crush/mcp.1/

- `extracted.json` — Declares support (~5576 tok)
- `meta.json` (~85 tok)

## .capmon-cache/crush/rules.0/

- `extracted.json` — Declares aliases (~3103 tok)
- `meta.json` (~85 tok)

## .capmon-cache/crush/skills.0/

- `extracted.json` (~452 tok)
- `meta.json` (~88 tok)

## .capmon-cache/crush/skills.1/

- `extracted.json` (~1330 tok)
- `meta.json` (~95 tok)

## .capmon-cache/factory-droid/agents-0/
...
## .capmon-cache/factory-droid/commands-0/
...
## .capmon-cache/factory-droid/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/factory-droid/hooks-1/
...
## .capmon-cache/factory-droid/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/factory-droid/mcp.0/

- `extracted.json` (~12350 tok)
- `meta.json` (~71 tok)

## .capmon-cache/factory-droid/rules-0/
...
## .capmon-cache/factory-droid/skills-0/
...
## .capmon-cache/gemini-cli/commands-0/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/commands.0/

- `extracted.json` (~2050 tok)
- `meta.json` (~88 tok)

## .capmon-cache/gemini-cli/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/hooks-1/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/hooks-2/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/hooks-3/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/hooks.0/

- `extracted.json` (~1665 tok)
- `meta.json` (~94 tok)

## .capmon-cache/gemini-cli/hooks.1/

- `extracted.json` (~4241 tok)
- `meta.json` (~89 tok)

## .capmon-cache/gemini-cli/hooks.2/

- `extracted.json` — is: action (~5727 tok)
- `meta.json` (~85 tok)

## .capmon-cache/gemini-cli/hooks.3/

- `extracted.json` (~10447 tok)
- `meta.json` (~86 tok)

## .capmon-cache/gemini-cli/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/mcp-1/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/mcp-2/
...
- `extracted.json` — Declares functionCalls (~13820 tok)
- `meta.json` (~87 tok)

## .capmon-cache/gemini-cli/mcp.2/

- `extracted.json` (~1078 tok)
- `meta.json` (~89 tok)

## .capmon-cache/gemini-cli/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/rules.0/

- `extracted.json` (~1301 tok)
- `meta.json` (~90 tok)

## .capmon-cache/gemini-cli/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/gemini-cli/skills.0/

- `extracted.json` (~611 tok)
- `meta.json` (~88 tok)

## .capmon-cache/kiro/agents-0/

- `meta.json` (~51 tok)

## .capmon-cache/kiro/agents.0/

- `extracted.json` (~12006 tok)
- `meta.json` (~80 tok)

## .capmon-cache/kiro/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/kiro/hooks.0/

- `extracted.json` (~3655 tok)
- `meta.json` (~70 tok)

## .capmon-cache/kiro/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/kiro/mcp.0/

- `extracted.json` (~6125 tok)
- `meta.json` (~73 tok)

## .capmon-cache/kiro/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/kiro/rules.0/

- `extracted.json` — /*\" - API routes and backend logic", (~4064 tok)
- `meta.json` (~70 tok)

## .capmon-cache/kiro/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/kiro/skills.0/

- `extracted.json` (~2081 tok)
- `meta.json` (~72 tok)

## .capmon-cache/opencode/agents.0/

- `extracted.json` (~208 tok)
- `meta.json` (~88 tok)

## .capmon-cache/opencode/commands.0/

- `extracted.json` (~153 tok)
- `meta.json` (~95 tok)

## .capmon-cache/opencode/mcp.0/

- `extracted.json` (~5422 tok)
- `meta.json` (~86 tok)

## .capmon-cache/opencode/mcp.1/

- `extracted.json` (~61 tok)
- `meta.json` (~90 tok)

## .capmon-cache/opencode/rules.0/

- `extracted.json` (~56 tok)
- `meta.json` (~89 tok)

## .capmon-cache/opencode/rules.1/

- `extracted.json` (~585 tok)
- `meta.json` (~88 tok)

## .capmon-cache/pi/commands-0/

- `meta.json` (~51 tok)

## .capmon-cache/pi/commands.0/

- `extracted.json` (~796 tok)
- `meta.json` (~95 tok)

## .capmon-cache/pi/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/pi/hooks-1/

- `meta.json` (~51 tok)

## .capmon-cache/pi/hooks-2/

- `meta.json` (~51 tok)

## .capmon-cache/pi/hooks.0/

- `extracted.json` (~887 tok)
- `meta.json` (~96 tok)

## .capmon-cache/pi/hooks.1/

- `extracted.json` (~21284 tok)
- `meta.json` (~93 tok)

## .capmon-cache/pi/hooks.2/

- `extracted.json` (~156 tok)
- `meta.json` (~97 tok)

## .capmon-cache/pi/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/pi/rules.0/

- `extracted.json` (~3209 tok)
- `meta.json` (~92 tok)

## .capmon-cache/pi/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/pi/skills-1/
...
- `extracted.json` (~98 tok)
- `meta.json` (~94 tok)

## .capmon-cache/roo-code/agents.0/

- `extracted.json` (~104 tok)
- `meta.json` (~90 tok)

## .capmon-cache/roo-code/agents.1/

- `extracted.json` (~132 tok)
- `meta.json` (~93 tok)

## .capmon-cache/roo-code/agents.2/

- `extracted.json` (~4668 tok)
- `meta.json` (~84 tok)

## .capmon-cache/roo-code/commands.0/

- `extracted.json` — Declares checking (~2153 tok)
- `meta.json` (~89 tok)

## .capmon-cache/roo-code/mcp.0/

- `extracted.json` — Declares servers (~635 tok)
- `meta.json` (~90 tok)

## .capmon-cache/roo-code/mcp.1/

- `extracted.json` (~123 tok)
- `meta.json` (~90 tok)

## .capmon-cache/roo-code/mcp.2/

- `extracted.json` (~58 tok)
- `meta.json` (~91 tok)

## .capmon-cache/roo-code/rules.0/

- `extracted.json` (~1407 tok)
- `meta.json` (~88 tok)

## .capmon-cache/roo-code/rules.1/

- `extracted.json` (~351 tok)
- `meta.json` (~92 tok)

## .capmon-cache/roo-code/skills.0/

- `extracted.json` — Declares is (~4730 tok)
- `meta.json` (~92 tok)

## .capmon-cache/roo-code/skills.1/

- `extracted.json` (~452 tok)
- `meta.json` (~84 tok)

## .capmon-cache/windsurf/agents-0/

- `meta.json` (~51 tok)

## .capmon-cache/windsurf/agents.0/

- `extracted.json` — ` — the content is applied only when Cascade reads or edits files inside that directory.", (~1864 tok)
- `meta.json` (~77 tok)

## .capmon-cache/windsurf/commands-0/

- `meta.json` (~51 tok)

## .capmon-cache/windsurf/commands.0/

- `extracted.json` — Declares that (~403 tok)
- `meta.json` (~77 tok)

## .capmon-cache/windsurf/hooks-0/

- `meta.json` (~51 tok)

## .capmon-cache/windsurf/hooks.0/

- `extracted.json` — Declares at (~6738 tok)
- `meta.json` (~76 tok)

## .capmon-cache/windsurf/mcp-0/

- `meta.json` (~51 tok)

## .capmon-cache/windsurf/mcp.0/

- `extracted.json` (~2580 tok)
- `meta.json` (~76 tok)

## .capmon-cache/windsurf/rules-0/

- `meta.json` (~51 tok)

## .capmon-cache/windsurf/rules-1/

- `meta.json` (~51 tok)

## .capmon-cache/windsurf/rules.0/

- `extracted.json` — /*.ts).", (~3816 tok)
- `meta.json` (~77 tok)
...
## .capmon-cache/windsurf/skills-0/

- `meta.json` (~51 tok)

## .capmon-cache/windsurf/skills.0/

- `extracted.json` (~3402 tok)
- `meta.json` (~76 tok)

## .capmon-cache/zed/agents.0/

- `extracted.json` (~312 tok)
- `meta.json` (~93 tok)

## .capmon-cache/zed/agents.1/

- `extracted.json` (~85 tok)
- `meta.json` (~93 tok)

## .capmon-cache/zed/agents.2/

- `extracted.json` (~216 tok)
- `meta.json` (~75 tok)

## .capmon-cache/zed/agents.3/

- `extracted.json` (~71 tok)
- `meta.json` (~75 tok)

## .capmon-cache/zed/commands.0/

- `extracted.json` (~90 tok)
- `meta.json` (~93 tok)

## .capmon-cache/zed/mcp.0/

- `extracted.json` (~172 tok)
- `meta.json` (~93 tok)

## .capmon-cache/zed/mcp.1/

- `extracted.json` (~136 tok)
- `meta.json` (~72 tok)

## .capmon-cache/zed/rules.0/

- `extracted.json` — Declares should (~3896 tok)
- `meta.json` (~84 tok)

## .capmon-cache/zed/rules.1/
...
- `release-guard.py` — Release guard hook for Claude Code. (~692 tok)
- `tui-context-gate.sh` — TUI Context Gate Hook (~264 tok)
- `tui-convention-check.sh` — TUI Convention Enforcement Hook (~906 tok)
- `tui-docs-gate.sh` — TUI Docs Gate Hook (~475 tok)
...
- `go-error-handling.md` — Go Conventions (CLI) (~298 tok)
- `openwolf.md` (~313 tok)
- `telemetry-enrichment.md` — Telemetry Enrichment Rule (~674 tok)
- `tui-elm.md` — Elm Architecture Enforcement (~852 tok)
- `tui-items-rebuild.md` — Content Refresh Pattern (~357 tok)
- `tui-layout.md` — Layout Arithmetic Rules (~476 tok)
- `tui-modals.md` — Modal Patterns (~367 tok)
- `tui-testing.md` — TUI Testing Patterns (~526 tok)
- `tui-wizard-patterns.md` — Wizard Step Machine Pattern (~609 tok)

## .claude/skills/release/

- `SKILL.md` — release (~778 tok)

## .claude/skills/release/tools/
...
- `SKILL.md` — TUI Builder — Golden Rules + Quick Reference (~1352 tok)

## .claude/skills/tui-builder/references/

- `dropdown-pattern.md` — Two-Tier Tab Navigation Pattern (~486 tok)
- `testing-setup.md` — TUI Testing Setup Reference (~1691 tok)

## .claude/worktrees/agent-a0114795/
...
- `CLAUDE.md` — Syllago (~979 tok)
- `CODE_OF_CONDUCT.md` — Contributor Covenant Code of Conduct (~1370 tok)
- `commands.json` (~16 tok)
- `CONTRIBUTING.md` — Contributing to syllago (~982 tok)
- `GEMINI.md` — Syllago (~697 tok)
- `install.sh` — Install syllago — AI coding tool content manager (~880 tok)
- `LICENSE` — Project license (~3025 tok)
- `Makefile` — Make build targets (~176 tok)
- `opencode.json` (~5 tok)
- `plan.md` — Contribution Model Implementation Plan (~1180 tok)
- `README.md` — Project documentation (~4201 tok)
- `ROADMAP.md` — Roadmap (~978 tok)
- `SECURITY.md` — Security Policy (~1360 tok)
- `TUI_MOCKUPS.md` — Syllago TUI: Adaptive Layout Specification (~2438 tok)
- `VERSION` (~2 tok)
...
## .claude/worktrees/agent-a0114795/.beads/

- `.gitignore` — Git ignore rules (~252 tok)
- `.local_version` (~2 tok)
- `beads.db-shm` (~8738 tok)
- `beads.db-wal` — Declares ON (~197745 tok)
- `beads.left.meta.json` (~26 tok)
- `config.yaml` — Beads Configuration File (~647 tok)
- `daemon.pid` (~2 tok)
- `interactions.jsonl` (~0 tok)
- `last-touched` (~4 tok)
- `metadata.json` (~18 tok)
...
## .claude/worktrees/agent-a0114795/.claude/

- `settings.json` (~421 tok)
- `settings.local.json` (~308 tok)

## .claude/worktrees/agent-a0114795/.claude/hooks/
...
## .claude/worktrees/agent-a0114795/.claude/rules/
...
- `tui-layout.md` — Layout Arithmetic Rules (~476 tok)
- `tui-modals.md` — Modal Patterns (~367 tok)
- `tui-testing.md` — TUI Testing Patterns (~395 tok)
- `tui-wizard-patterns.md` — Wizard Step Machine Pattern (~609 tok)

## .claude/worktrees/agent-a0114795/.claude/skills/release/

- `SKILL.md` — release (~778 tok)

## .claude/worktrees/agent-a0114795/.claude/skills/release/tools/

- `.gitkeep` (~0 tok)

## .claude/worktrees/agent-a0114795/.claude/skills/release/workflows/

- `create-release.md` — Create Release Workflow (~1286 tok)

## .claude/worktrees/agent-a0114795/.claude/skills/tui-builder/

- `SKILL.md` — TUI Builder — Golden Rules + Quick Reference (~1352 tok)

## .claude/worktrees/agent-a0114795/.claude/skills/tui-builder/references/

- `dropdown-pattern.md` — Two-Tier Tab Navigation Pattern (~486 tok)
- `testing-setup.md` — TUI Testing Setup Reference (~1691 tok)

## .claude/worktrees/agent-a0114795/.copilot/

- `mcp.json` (~5 tok)

## .claude/worktrees/agent-a0114795/.githooks/

- `pre-commit` — bd (beads) pre-commit hook (~707 tok)
- `pre-push` — Pre-push hook: run golangci-lint and check commands.json freshness (~677 tok)

## .claude/worktrees/agent-a0114795/.github/

- `dependabot.yml` (~60 tok)
- `PULL_REQUEST_TEMPLATE.md` — Summary (~138 tok)
- `vouch-pr-response.md` (~202 tok)
- `VOUCHED.td` — Vouched contributors for syllago. (~141 tok)

## .claude/worktrees/agent-a0114795/.github/ISSUE_TEMPLATE/

- `bug-report.yml` (~590 tok)
- `config.yml` (~68 tok)
- `content-request.yml` — Declares attributes (~700 tok)
- `feature-idea.yml` (~552 tok)
- `improvement.yml` (~478 tok)

## .claude/worktrees/agent-a0114795/.github/workflows/

- `ci.yml` — CI: CI (~822 tok)
- `claude-code-review.yml` — /*.ts" (~446 tok)
- `claude.yml` — CI: Claude Code (~532 tok)
- `codeql.yml` — CI: CodeQL (~271 tok)
- `pr-policy.yml` — CI: "Vouch: Check PR" (~181 tok)
- `release.yml` — CI: Release (~2126 tok)
- `scorecard.yml` — CI: Scorecard (~329 tok)
...
## .scratch/panel/moat-trusted-root/

- `consensus.md` — Panel Consensus — MOAT G-3 Trusted Root & Slice Scope (~2627 tok)
- `r1-enterprise-security.txt` (~1239 tok)
- `r1-karpathy.txt` — Declares before (~931 tok)
- `r1-remy.txt` (~1032 tok)
- `r1-spec-purist.txt` (~1023 tok)
- `r1-valsorda.txt` — Declares of (~1411 tok)
- `r2-enterprise-security.txt` (~2636 tok)
- `r2-karpathy.txt` — Declares of (~2595 tok)
- `r2-remy.txt` — Declares temptation (~3083 tok)
- `r2-spec-purist.txt` — Declares of (~2928 tok)
- `r2-valsorda.txt` — Declares he (~2831 tok)
- `r3-enterprise-security.txt` (~3109 tok)
- `r3-karpathy.txt` — Declares of (~2525 tok)
- `r3-remy.txt` — Declares of (~3169 tok)
- `r3-spec-purist.txt` (~3700 tok)
...
- `main.go` — provider-monitor checks provider source manifests for broken URLs and version drift. (~1764 tok)
...
- `coverage_extras_test.go` — Struct: stubConverter (~10302 tok)
...
- `gencontentformat.go` — Struct: ContentFormatManifest (~555 tok)
- `genproviders_test.go` — TestGenproviders, TestGenproviders_ClaudeCodeHookDetails, TestGenproviders_NonCCProviderEnrichment (~6503 tok)
- `genproviders.go` — Struct: ProviderManifest (~3039 tok)
- `genyamlschema_test.go` — TestGenyamlschema_EmitsValidJSON, TestGenyamlschema_IncludesIDField, TestGenyamlschema_MissingSource (~553 tok)
- `genyamlschema.go` — Struct: YAMLSchemaManifest (~413 tok)
...
- `registry_cmd_moat_autodetect_test.go` — TestRegistryAutoMOAT_AllowlistURL_SetsManifestURI, TestRegistryAutoMOAT_RegistryYAML_SetsManifestURI (~2304 tok)
- `registry_cmd_test.go` — TestRegistryAddRejectsDisallowedURL, TestRegistryAddAllowsURLWhenNoPolicy, TestRegistryAddAllowsURLI (~5307 tok)
- `registry_cmd.go` — Declares skills (~8086 tok)
...
- `detector_content_signal_test.go` — TestContentSignalDetector_PreFilter_ExtensionReject, TestContentSignalDetector_PreFilter_ExtensionAc (~3405 tok)
- `detector_content_signal.go` — Struct: SignalEntry (~2871 tok)
- `detector_cursor_test.go` — TestCursorDetector_ProviderSlug, TestCursorDetector_Patterns, TestCursorDetector_Classify (~784 tok)
- `detector_cursor.go` — Struct: CursorDetector (~708 tok)
- `walk_test.go` — TestWalk_EmptyDir, TestWalk_ExcludesNodeModules, TestWalk_ExtraExcludeDirs, TestWalk_ExcludesBinaryF (~970 tok)

## cli/internal/audit/

- `audit_test.go` — Struct: failingWriter (~3044 tok)
- `audit.go` — provides structured JSON audit logging for content and hook lifecycle events. (~1302 tok)

## cli/internal/capmon/

- `backfill_test.go` — Struct: stubFetcher (~2962 tok)
- `backfill.go` — Interface: SourceFetcher (~2320 tok)
...
- `check_test.go` — Struct: checkTestEnv (~4318 tok)
...
## cli/internal/capmon/extract_markdown/

- `extract_markdown_test.go` — TestMarkdownExtractor_HeadingPath, TestMarkdownExtractor_Landmarks, TestMarkdownExtractor_AnchorMiss (~2760 tok)
- `extract_markdown.go` — Struct: markdownExtractor (~1095 tok)
...
- `extract_typescript_test.go` — go:build cgo (~1835 tok)
- `extract_typescript.go` — go:build cgo (~1784 tok)

## cli/internal/capmon/extract_yaml/

- `extract_yaml.go` — Struct: yamlExtractor (~660 tok)
...
- `config_moat_test.go` — TestRegistry_BackCompat_EmptyTypeIsGit, TestRegistry_ExplicitGit, TestRegistry_MOATRoundTrip, TestRe (~5262 tok)
- `config.go` — Struct: SigningProfile (~4978 tok)

## cli/internal/contentformat/

- `enums.go` — declares canonical enum values for .syllago.yaml (~515 tok)
...
- `gitutil_test.go` — TestIsInsideGitRepo_False, TestIsInsideGitRepo_True, TestInitAndCommit, TestInitAndCommit_NoGit, Tes (~827 tok)
- `gitutil.go` — IsInsideGitRepo, InitAndCommit, Username (~520 tok)
...
- `bundle_builder.go` — BuildBundle, VerifyItemSigstore (~1843 tok)
...
- `freshness.go` — — manifest freshness / staleness enforcement. (~2011 tok)
...
- `lockfile_test.go` — TestNewLockfile_Invariants, TestLockfile_RoundTripEmpty, TestLockfile_LoadMissingFileReturnsFresh, T (~6970 tok)
- `lockfile.go` — Struct: RegistryLockState (~5071 tok)
...
- `manifest_verify_test.go` — TestVerifyManifest_HappyPath_TOFU, TestVerifyManifest_HappyPath_NumericIDsMatched, TestVerifyManifes (~3798 tok)
- `manifest_verify.go` — Struct: VerificationResult (~3754 tok)
...
- `revocation.go` — — revocation enforcement. (~1974 tok)
- `sanitize_test.go` — TestSanitizeForDisplay, TestSanitizeForDisplay_Idempotent (~1087 tok)
- `sanitize.go` — SanitizeForDisplay (~1638 tok)
...
- `checker_source_hash_test.go` — Struct: fixtureSource (~2888 tok)
- `checker_source_hash.go` — Struct: taggedSource (~1984 tok)
- `checker_test.go` — TestCheckURLs, TestCheckVersion_GitHubReleases, TestCheckVersion_NoDrift, TestCheckVersion_UnknownMe (~1534 tok)
- `checker.go` — Struct: URLResult (~2218 tok)
- `manifest_test.go` — TestLoadManifest, TestLoadManifest_MissingSlugs, TestAllURLs, TestLoadAllManifests, TestLoadAllManif (~1523 tok)
- `manifest.go` — implements provider source manifest loading, URL health (~1495 tok)

## cli/internal/registry/

- `client_test.go` — TestGitClient_SatisfiesInterface, TestGitClient_Type, TestGitClient_Trust, TestGitClient_Items_Scans (~2254 tok)
- `client.go` — Interface: RegistryClient (~1378 tok)
- `coverage_test.go` — Struct: redirectTransport (~3911 tok)
- `git_client.go` — Struct: GitClient (~1401 tok)
- `integration_test.go` — TestIntegration_CloneAndDiscover, TestIntegration_Remove, TestIntegration_Sync, TestIntegration_Dupl (~5836 tok)
- `ops.go` — — registry orchestration shared by CLI and TUI. (~2058 tok)
- `registry_test.go` — TestNameFromURL, TestExpandAlias_OfficialAlias, TestExpandAlias_FullURL_NotExpanded, TestExpandAlias (~4025 tok)
- `registry.go` — Struct: SyncResult (~2678 tok)
...
- `runner.go` — Struct: RunConfig (~2488 tok)

## cli/internal/snapshot/

- `snapshot_test.go` — TestCreate_BacksUpFiles, TestCreate_SkipsMissingFiles, TestLoad_NoSnapshot, TestLoad_EmptySnapshotsD (~5479 tok)
- `snapshot.go` — Struct: SnapshotManifest (~2713 tok)

## cli/internal/telemetry/

- `catalog.go` — Struct: EventDef (~1755 tok)
- `telemetry_test.go` — TestInit_DevBuild_NoAPIKey, TestInit_DNTSet, TestInit_UnreadableConfig_DisabledForSession, TestInit_ (~4960 tok)
- `telemetry.go` — Struct: postHogPayload (~2145 tok)
...
- `cards.go` — Struct: cardData (~3683 tok)
...
- `filetree_test.go` — TestFileTree_SelectPath_MovesCursor, TestFileTree_SelectPath_DirectorySkippedByPath, TestFileTree_Se (~792 tok)
...
- `copilot-cli.yaml` (~9223 tok)
- `crush.yaml` (~3312 tok)
- `cursor.yaml` (~7252 tok)
- `factory-droid.yaml` — Declares entries (~5917 tok)
- `gemini-cli.yaml` (~7280 tok)
- `kiro.yaml` — Declares that (~7668 tok)
- `opencode.yaml` (~4248 tok)
- `pi.yaml` — Declares as (~6274 tok)
- `roo-code.yaml` — Declares field (~7067 tok)
- `windsurf.yaml` (~7406 tok)
- `zed.yaml` — Declares content (~1969 tok)
...
- `copilot-cli.yaml` — Copilot CLI — Provider Source Manifest (~1467 tok)
...
- `zed.yaml` — Zed — Provider Source Manifest (~806 tok)
