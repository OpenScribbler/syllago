...
**Date:** 2026-02-17
**Plan:** `/home/hhewett/.local/src/romanesco/docs/plans/2026-02-17-tui-redesign-implementation.md`
**Codebase:** `/home/hhewett/.local/src/romanesco/cli/internal/tui/`
...
- [ ] **Missing context — `promote` import needed in app.go** — Task 3.3 Step 3 introduces `promote.Promote()` directly in `App.Update()`:
  ...
  - **Fix:** Add to the task: "Add `\"github.com/holdenhewett/romanesco/cli/internal/promote\"` to app.go imports."
