...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go get github.com/spf13/cobra@latest
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./cmd/nesco/... && go build ./cmd/nesco && go test ./...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/model/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/provider/... && go test ./...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/config/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/output/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/parse/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/parity/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./cmd/nesco/... && go build ./cmd/nesco
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./cmd/nesco/... && go build ./cmd/nesco && ./nesco --help
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/scan/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/scan/detectors/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/emit/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/reconcile/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./internal/drift/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go test ./cmd/nesco/...
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go build ./cmd/nesco && ./nesco scan --help
```
...
```bash
cd /home/hhewett/.local/src/romanesco/cli && go build ./cmd/nesco && ./nesco --help
```
