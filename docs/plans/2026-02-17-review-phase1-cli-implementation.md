...
**Goal:** Fix 15 CLI flag and error handling issues identified in the syllago review
...
**Files:**
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`
...
Add to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`:
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestNoColorFlag -v
```
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 38-46)
...
Update the `init()` function in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (after line 42, before line 44):
...
Add required imports to the existing import block in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go`:
...
import (
	...
	"github.com/OpenScribbler/syllago/cli/internal/scan/detectors"
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/cmd/syllago/main.go cli/cmd/syllago/main_test.go && git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/output/output.go` (line 10-23)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/output/output_test.go`
...
Add to `/home/hhewett/.local/src/syllago/cli/internal/output/output_test.go`:
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./internal/output/ -run TestPrintQuietMode -v
```
...
Update `/home/hhewett/.local/src/syllago/cli/internal/output/output.go`:
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/internal/output/output.go cli/internal/output/output_test.go && git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 44-51)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestQuietFlag -v
```
...
Update the `PersistentPreRunE` in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (after line 44):
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/output/output.go` (line 10-15, add after line 23)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/output/output_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./internal/output/ -run TestPrintVerbose -v
```
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 44-54)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestVerboseFlag -v
```
...
Update the `PersistentPreRunE` in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 44-54):
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/cmd/syllago/main.go cli/internal/output/output.go cli/cmd/syllago/main_test.go && git commit -m "$(cat <<'EOF'
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestVersionCommandDevBuild -v
```
...
Update the `versionCmd` in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (lines 48-54):
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` (lines 16-26, the RunE function body)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info_test.go`
...
Add to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info_test.go`:
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestInfoDevBuild -v
```
...
Update `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` RunE function (lines 16-26):
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/cmd/syllago/info.go cli/cmd/syllago/info_test.go && git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/output/output.go`
- Test: `/home/hhewett/.local/src/syllago/cli/internal/output/output_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./internal/output/ -run TestSilentError -v
```
...
Add to `/home/hhewett/.local/src/syllago/cli/internal/output/output.go`:
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 109-112)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestMainSilentErrorNotPrinted -v
```
...
Update the `main()` function in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (around line 109):
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -v
```
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/cmd/syllago/main.go && git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan.go` (lines 36-39)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan_test.go`
...
Add to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan_test.go`:
...
Add required imports to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan_test.go`:
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestScanErrorNoDuplicate -v
```
...
Update `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan.go` (lines 36-39):
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/cmd/syllago/scan.go cli/cmd/syllago/scan_test.go && git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 118, line 184, and convert findSkillsDir to a var)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`
...
First, update `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` to make findSkillsDir testable. After line 186, convert the function:
...
Then add the test to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`:
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestTUIErrorMessageContentRepoNotFound -v
```
...
Update the `runTUI` function in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 118):

```go
func runTUI(cmd *cobra.Command, args []string) error {
	root, err := findContentRepoRoot()
	if err != nil {
		return fmt.Errorf("syllago requires a content repository.\n\nTo get started:\n  syllago init    Create a new content repo in the current directory\n  syllago --dir   Point to an existing content repo\n\nFor more info: syllago --help")
	}
...
message that explains what syllago needs and suggests actionable
fixes (run from content repo or clone syllago repo).
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/helpers.go` (lines 14-40, the findProjectRootImpl function)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/helpers_test.go` (new file)
...
Create `/home/hhewett/.local/src/syllago/cli/cmd/syllago/helpers_test.go`:
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestFindProjectRootFallbackWarning -v
```
...
Update the `findProjectRootImpl` function in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/helpers.go` (lines 14-40). Note that `var findProjectRoot = findProjectRootImpl` already exists at line 12, so we only need to modify the implementation function:
...
func findProjectRootImpl() (string, error) {
	...
	fmt.Fprintf(output.ErrWriter, "  To avoid unintended file operations, run syllago from a project root or use --dir flag.\n")
	return cwd, nil
}
```
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/cmd/syllago/helpers.go cli/cmd/syllago/helpers_test.go && git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan.go` (lines 56-62, the auto-detect block)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan_test.go`
...
func TestScanConfigSaveError(t *testing.T) {
	...
	// Create .syllago dir as read-only to force Save error
	syllagoDir := filepath.Join(tmp, ".syllago")
	os.MkdirAll(syllagoDir, 0444)
	defer os.Chmod(syllagoDir, 0755) // cleanup
	...
	os.Setenv("SYLLAGO_NO_PROMPT", "1")
	defer os.Unsetenv("SYLLAGO_NO_PROMPT")
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestScanConfigSaveError -v
```
...
Update `/home/hhewett/.local/src/syllago/cli/cmd/syllago/scan.go` (lines 56-62):
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (lines 32-33, the Long field)

**Depends on:** Task 11

**Success Criteria:**
- [ ] Test verifies help text mentions running without arguments launches TUI
- [ ] Help text appears in `syllago --help` output
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestHelpTextMentionsTUI -v
```
...
Update the `rootCmd` Long field in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (lines 32-33):

```go
var rootCmd = &cobra.Command{
	Use:   "syllago",
	Short: "AI coding tool content manager and codebase scanner",
	Long: `Syllago manages AI tool configurations and scans codebases for context that helps AI agents produce correct code.
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd.go` (line 65, 96)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd_test.go`
...
Add to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd_test.go`:
...
Add required imports to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd_test.go`:
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run "TestConfigAddConfirmation|TestConfigRemoveConfirmation" -v
```
...
Update `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd.go`:
...
```bash
cd /home/hhewett/.local/src/syllago && git add cli/cmd/syllago/config_cmd.go cli/cmd/syllago/config_cmd_test.go && git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (add wrapTTYError function before runTUI, update line 150-152 in runTUI)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main_test.go`
...
First, add a minimal stub to `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (before `runTUI`, around line 114):
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestTUITTYErrorWrapped -v
```
...
Replace the stub `wrapTTYError` function in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go`:
...
func wrapTTYError(err error) error {
	...
	if strings.Contains(errMsg, "TTY") || strings.Contains(errMsg, "tty") {
		return fmt.Errorf("syllago requires a terminal for interactive mode. Use subcommands for non-interactive usage (try: syllago scan)")
	}
	return err
}
```
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd.go` (line 58-64)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run "TestConfigAddUnknownProviderWarning|TestConfigAddKnownProviderNoWarning" -v
```
...
Update `configAddCmd` in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd.go` (around line 58-66):
...
```go
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if findProviderBySlug(slug) == nil {
			...
			fmt.Fprintf(output.ErrWriter, "  Adding anyway - syllago will ignore unknown providers during scan.\n")
		}
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd.go` (update warning message)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestConfigAddWarningListsKnownProviders -v
```
...
Update the warning in `configAddCmd` in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/config_cmd.go`:
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` (line 55)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestInfoProvidersUsesDisplayNames -v
```
...
Looking more carefully at line 65 and the finding description, the issue is in the types list. Update `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` (around line 50-70):
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` (line 92-95)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestInfoFormatsShowsProviders -v
```
...
Update `infoFormatsCmd` in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` (around line 90-98):
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` (line 28-29)
- Test: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info_test.go`
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestInfoNotesStandaloneTypes -v
```
...
Update the plain text output in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/info.go` (around line 25-35):
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./internal/output/ -run TestExitCodeConstants -v
```
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 112)
...
Update `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (around line 109-112):
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (line 32)
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./cmd/syllago/ -run TestHelpDocumentsExitCodes -v
```
...
Update the `rootCmd` Long description in `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (around line 29-36):
...
**Success Criteria:**
- [ ] All tests in `cli/cmd/syllago/` pass
...
### Step 1: Run tests for cmd/syllago package
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go test ./internal/output/ -v
```
...
```bash
cd /home/hhewett/.local/src/syllago/cli && go vet ./cmd/syllago/ ./internal/output/
```
...
- cli/cmd/syllago/main_test.go
- cli/cmd/syllago/helpers.go
- cli/cmd/syllago/helpers_test.go (new)
- cli/cmd/syllago/config_cmd.go
- cli/cmd/syllago/config_cmd_test.go
- cli/cmd/syllago/info.go
- cli/cmd/syllago/info_test.go
- cli/cmd/syllago/scan.go
- cli/cmd/syllago/scan_test.go
