...
**Goal:** Refactor the Syllago TUI from full-screen replacement navigation to a persistent sidebar + content layout with modal overlays, mouse support, and the Syllago color palette.
...
**Design Doc:** `/home/hhewett/.local/src/syllago/docs/plans/2026-02-17-tui-redesign-design.md`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/styles.go` (lines 5-14)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/styles_test.go`

**Depends on:** nothing

**Success Criteria:**
- [ ] Six semantic colors match Syllago palette values exactly
...
func TestSyllagoPaletteValues(t *testing.T) {
	// Verify the primary color uses the Syllago mint value (not the old color)
	ac, ok := primaryColor.(lipgloss.AdaptiveColor)
	if !ok {
		t.Fatal("primaryColor should be AdaptiveColor")
	}
	if ac.Dark != "#6EE7B7" {
		t.Errorf("primaryColor.Dark should be #6EE7B7 (Syllago mint), got %s", ac.Dark)
	}
	if ac.Light != "#047857" {
		t.Errorf("primaryColor.Light should be #047857 (Syllago mint dark), got %s", ac.Light)
	}
	...
	if acc.Dark != "#C4B5FD" {
		t.Errorf("accentColor.Dark should be #C4B5FD (Syllago viola), got %s", acc.Dark)
	}
}
...
Run: `cd /home/hhewett/.local/src/syllago/cli && go test ./internal/tui/...`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/styles_test.go` (lines 21-34)
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/go.mod` (via go get)
- Modify: `/home/hhewett/.local/src/syllago/cli/go.sum` (via go get)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/styles_test.go`
...
Run: `cd /home/hhewett/.local/src/syllago/cli && go build ./...`
...
**Files:**
- Create: `/home/hhewett/.local/src/syllago/cli/internal/tui/sidebar.go`
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/sidebar_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go` (lines 27-56, 60-71)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/app_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go` (lines 16-25, 27-56)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/app_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go` (lines 511-553)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/app_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go` (lines 77-509)
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/keys.go` (add `Right` binding)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/app_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go` (App.View switch)
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go` (App struct, NewApp)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/app_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/detail_render.go` (lines 15-50)
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/detail.go` (`clampScroll()` method — Step 4 rewrites it)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/detail_render_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/cmd/syllago/main.go` (around line 196)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/styles_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/sidebar.go`
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/sidebar_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/items.go` (View method)
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/detail_render.go` (renderTabBar)
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go` (MouseMsg handler + App.View return)
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/detail_render_test.go`
...
**Files:**
- Create: `/home/hhewett/.local/src/syllago/cli/internal/tui/modal.go`
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/modal_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go`
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/modal_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/modal.go`
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/detail.go`
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/app.go`
- Test: `/home/hhewett/.local/src/syllago/cli/internal/tui/modal_test.go`
...
**Files:**
- Modify: `/home/hhewett/.local/src/syllago/cli/internal/tui/styles_test.go`
...
// TestColorsPassWCAGAA verifies all Syllago palette colors achieve >= 4.5:1
...
| File | Action |
|------|--------|
| `cli/internal/tui/styles.go` | Modify: Syllago palette + panel styles |
...
| `cli/cmd/syllago/main.go` | Modify: zone.NewGlobal() + tea.WithMouseCellMotion() |
