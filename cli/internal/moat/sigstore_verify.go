...
// MOAT attestation item using sigstore-go. This is the production path:
// Fulcio cert chain is checked against trusted roots, Rekor inclusion proof
// and SET are verified, and the OIDC identity is constrained to the
// expected publisher profile.
//
